...
class XlsxParser {
    async parse(input, options = {}) {
        const bytes = typeof input === "string" ? new Uint8Array(await promises.readFile(input)) : input;
...
exports.Chart = Chart;
exports.EXCEL_MAX_COL_0BASED = EXCEL_MAX_COL_0BASED;
exports.EXCEL_MAX_COL_1BASED = EXCEL_MAX_COL_1BASED;
exports.EXCEL_MAX_ROW_0BASED = EXCEL_MAX_ROW_0BASED;
exports.EXCEL_MAX_ROW_1BASED = EXCEL_MAX_ROW_1BASED;
exports.Table = Table;
exports.Workbook = Workbook;
exports.Worksheet = Worksheet;
exports.XlsxDocument = XlsxDocument;
